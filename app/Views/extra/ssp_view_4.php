      ...
      $(document).ready(function() {
         ...
         var table = $sspDTbl.DataTable({
            ...
            'columnDefs': [
	            ...
	            return '<button class="edit btn btn-primary">Edit</button> <button class="delete btn btn-danger">Delete</button> ';
	            }
	            }
         ...
         $sspDTbl.on("click", ".edit, .delete", function(){
...
<script>
      /* $(function() {
        if ($("#ssp-datatable").length > 0) {

           var table = $("#ssp-datatable").DataTable({
              scrollY: "300px",
              scrollX: true,
              scrollCollapse: true,
              paging: true,
